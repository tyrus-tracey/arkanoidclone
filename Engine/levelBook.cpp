...
levelParams levelBook::genLv1()
{
	...
	initBrickHori(out, 4, 0, 12, RED);
	initBrickHori(out, 5, 0, 12, BALL);
	return out;
}
...
levelParams levelBook::genLv2()
{
	...
	initBrickHori(out, 0, 3, 7, BALL);
	initBrickHori(out, 10, 3, 7, BALL);
	initBrickVert(out, 3, 0, 10, BALL);
	initBrickVert(out, 7, 0, 10, BALL);
...
levelParams levelBook::genLv3()
{
	...
	initBrickHori(out, 4, 0, 19, RED);
	initBrickHori(out, 5, 0, 19, BALL);
	initBrickHori(out, 6, 0, 29, RED);
